...
namespace MobyLabWebProgramming.Infrastructure.Migrations
{
    ...
    [Migration("20240408165045_ReservationUpdateConfiguration")]
    partial class ReservationUpdateConfiguration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MobyLabWebProgramming.Core.Entities.Request", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MobyLabWebProgramming.Core.Entities.Request", b =>
                {
                    ...
                    b.HasOne("MobyLabWebProgramming.Core.Entities.User", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("MobyLabWebProgramming.Core.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("MobyLabWebProgramming.Core.Entities.Request", "Request")
                        .WithOne()
                        .HasForeignKey("MobyLabWebProgramming.Core.Entities.Reservation", "RequestId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
