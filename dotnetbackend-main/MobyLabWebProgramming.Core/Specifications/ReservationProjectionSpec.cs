                                                                                                        ...
                                                                                                        EF.Functions.Like(e.Car.Brand, searchExpr) ||
                                                                                                                                EF.Functions.Like(e.Car.Model, searchExpr) ||
                                                                                                                                                        EF.Functions.Like(e.Car.LicensePlate, searchExpr) ||
                                                                                                                                                                                EF.Functions.Like(e.Car.Transmission.ToString(), searchExpr) ||
                                                                                                                                                                                                        EF.Functions.Like(e.Car.BodyType.ToString(), searchExpr) ||
                                                                                                                                                                                                                                EF.Functions.Like(e.Car.FuelType.ToString(), searchExpr) ||
